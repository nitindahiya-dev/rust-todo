...
export default function Dashboard() {
  // Use useState hook before any returns
  ...
  // Now we can safely define links
  const links = [
    {
      label: "Dashboard",
      href: "#",
  ...
  return (
    <div className="">
      <div
        className={cn(
          " mt-[5vh] rounded-md flex flex-col md:flex-row bg-black w-full flex-1 max-w-[90vw] mx-auto overflow-hidden h-[90vh]"
        )}
      >
